...
$query = "SELECT collection.* FROM collection JOIN admin ON collection.admin = admin.id WHERE admin.username='$userprofile' AND collection.status = 'Yes';";
...
<div class="row">
  <div class="col-3 col-s-3 menu">
    ...
    <li style="background-color:#9933cc;">Sort By: </a></li>
        ...
        <li><a class="active" href="adminglued.php">Glued</a></li>
