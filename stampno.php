...
$query = "SELECT collection.*,admin.* FROM collection JOIN admin ON collection.admin = admin.id ORDER BY collection.stamp_count DESC;";
...
<div class="row">
  <div class="col-3 col-s-3 menu">
    ...
    <li style="background-color:#9933cc;">Sort By: </a></li>
        ...
        <li><a class="active" href="stampno.php">Number Of Stamps</a></li>
