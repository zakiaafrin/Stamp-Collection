...
$query = "SELECT collection.*,admin.* FROM collection JOIN admin ON collection.admin = admin.id WHERE collection.country='United States' AND admin.username='$userprofile'" ;
...
?>
        ...
        <li><a class="active" href="adminusa.php">USA</a></li>
