...
$query = "SELECT collection.*,admin.* FROM collection JOIN admin ON collection.admin = admin.id WHERE collection.country='Australia';";
...
?>
        ...
        <li><a class="active" href="australia.php">Australia</a></li>
