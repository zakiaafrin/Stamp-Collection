...
$query = "SELECT collection.*,admin.* FROM collection JOIN admin ON collection.admin = admin.id WHERE collection.country='Bangladesh'AND admin.username='$userprofile'";
...
?>
        ...
        <li><a class="active" href="adminbangladesh.php">Bangladesh</a></li>
