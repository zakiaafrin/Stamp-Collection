<?php
  ...
  error_reporting(0);
  if(count($_SESSION)) header("Location: indexadmin.php");
?>
      ...
      <form action="" method="post" enctype="multipart/form-data" style="border:3px solid #f1f1f1">
        <div class="container" style="height: 26.39vw;">
          ...
          <div id ="form" style="padding-bottom:100px ;">
            <br/>Have an account? <a style="margin-left: 15px; color:green;" href="adminlogin.php"><strong>Log In</strong></a>
          </div>
        </div><br/><br/>
      </form> 
    <?php
...
if(isset($_POST['submit'])){
  ...
  if (mysqli_num_rows($con_user) > 0) {
      echo "<br/>Sorry. Username already taken.";     
