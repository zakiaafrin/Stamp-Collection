...
$query = "SELECT * FROM collection WHERE admin='$userprofile' AND country NOT IN ('Bangladesh', 'United States', 'Australia', 'London')";
...
?>
        ...
        <li><a class="active" href="adminothers.php">Other Countries</a></li>
